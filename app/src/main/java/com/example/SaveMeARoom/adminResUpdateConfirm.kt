    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnYesResUpdateConfirm.setOnClickListener {
            if(flag == "1"){
                ...
                query = "/search?query=UPDATE%20reservations%20SET%20Updating='0',Viewing=0,Start_Date_Time=%27" + newStart + "%27,End_Date_Time=%27" + newEnd + "%27%20WHERE%20Reservation_Id=%27" + resId + "%27"
                ...
                query = "/search?query=UPDATE%20reservations%20SET%20Updating='0',Viewing=0%20WHERE%20Reservation_Id=%27" + resId + "%27"
