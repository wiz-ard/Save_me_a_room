...
class homeRecycleAdapter (var buildings: List<buildingname>, private val clickListener: (buildingname) -> Unit) : RecyclerView.Adapter<homeRecycleAdapter.BuildingViewHolder>() {
