    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnConfirm.setOnClickListener {
            ...
            if(resNum < 3) {
                ...
                query ="/search?query=INSERT%20INTO%20reservations%20VALUES(%27" + buildingName + "%27," + room + ",%27" + email + "%27," + occupancy + ",%27" + date + "%20" + start + "%27,%27" + date + "%20" + end + "%27, 1, %27"+college+"%27,%27" + resId + "%27,0)"
