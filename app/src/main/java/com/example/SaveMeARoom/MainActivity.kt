            ...
            if(validInput(username) && validInput(password)){
                if(username.length > 0 && password.length > 0) {
                    ...
                    if (text.length > 2) {
                        ...
                        val query =
                            "/search?query=INSERT%20INTO%20userlogs%20VALUES(%27" + username + "%27,%27" + logTime + "%27, %27empty%27,%27True%27,%27" + college + "%27)"
                        ...
                        val query =
                            "/search?query=INSERT%20INTO%20userlogs%20VALUES(%27" + username + "%27,%27" + logTime + "%27,%27empty%27,%27False%27,%27empty%27)"
