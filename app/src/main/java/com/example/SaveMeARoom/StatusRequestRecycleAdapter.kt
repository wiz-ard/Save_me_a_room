...
class StatusRequestRecycleAdapter (var acceptedRes: List<statusReqData>, private val clickListener: (statusReqData) -> Unit) : RecyclerView.Adapter<StatusRequestRecycleAdapter.BuildingViewHolder>() {
