...
class UpdateDateAdaptor (var Date: List<dateData>, private val clickListener: (dateData) -> Unit) : RecyclerView.Adapter<UpdateDateAdaptor.DateViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DateViewHolder {
        val vh = DateViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.time_items, parent, false)){
